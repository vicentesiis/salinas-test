...
class FavoriteShowViewController: UIViewController {
    ...
    var shows = Show.all().filter("isFavorite == true")
    var realm = try! Realm()
...
extension FavoriteShowViewController: UITableViewDelegate {
...
extension FavoriteShowViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        let contextItemDelete = UIContextualAction(style: .destructive, title: "Delete") {  (_, _, boolValue) in
            ...
            Utils.presentAlert(in: self, title: "Borrar", message: "Está seguro que desea borrar de favoritos \(show.name)", alertActions: [acceptAction], closeAction: closeAction)
